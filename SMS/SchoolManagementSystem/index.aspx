...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="slider" >
		<ul class="bxslider"  style ="background-image:url(assets/img/cancel.png)">
           
			<li>
				<div class="container">
					<div class="info">
						<h2 runat="server" id="Slider1t"></h2>
						<a href="#" runat="server" id="Slider1sd"></a>
					</div>
				</div>
				<!-- / content -->
			</li>
	...
	<section class="posts">
		<div class="container">
			<article>
				<div class="pic"><img width="121" src="../assets/site/images/2.png" alt=""></div>
				<div class="info">
